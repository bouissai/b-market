...
import RecipeGrid from '@/components/user/recipe/recipe-grid';
import RecipeFilters from '@/components/user/recipe/recipe-filters';
...
const recipes = [
  {
    ...
    forEvents: false,
    ingredients: [
      { id: '1', name: "Épaule d'agneau", quantity: '800g', available: true },
  ...
  },
  {
    ...
    forEvents: false,
    ingredients: [
      { id: '1', name: 'Poulet fermier', quantity: '1.5kg', available: true },
      { id: '2', name: 'Thym', quantity: 'quelques branches', available: true },
      {
        id: '3',
        name: 'Romarin',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '2', name: 'Blanc de poulet', quantity: '500g', available: true },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '4', name: 'Feuilles de brick', quantity: '12', available: true },
      {
        id: '5',
        name: 'Cannelle',
        quantity: '1 cuillère à café',
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="general" className="space-y-8">
            <div className="flex justify-between items-center">
              <TabsList>
                <TabsTrigger value="general">Recettes du quotidien</TabsTrigger>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-8">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-6">
                      Des recettes parfaites pour vos grandes tablées, fêtes et
                      célébrations. Idéales pour impressionner vos invités et
