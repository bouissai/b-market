...
const sampleOrders: Order[] = [
  ...
  },
  {
    ...
    statusHistory: [
      ...
      { status: "En livraison", date: "2023-11-03 10:00", note: "Votre commande est en cours de livraison." },
      { status: "Livrée", date: "2023-11-03 14:20", note: "Votre commande a été livrée avec succès." },
    ],
  },
  {
    id: "3",
  ...
  },
  {
    ...
    statusHistory: [
      ...
      { status: "Terminée", date: "2023-10-19 10:45", note: "Votre commande a été retirée avec succès." },
    ],
  },
  {
    id: "5",
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>{order.deliveryMethod === "delivery" ? "5,00 €" : "Gratuit"}</span>
                    </div>
                    <Separator className="my-2" />
                    <div className="flex justify-between font-bold">
                      <span>Total</span>
                      <span>{(order.total + (order.deliveryMethod === "delivery" ? 5 : 0)).toFixed(2)} €</span>
                    </div>
                  </div>
                </div>
              </CardContent>
                  ...
                  {order.statusHistory.map((status, index) => (
                    <div key={index} className="flex">
                      <div className="mr-4 flex flex-col items-center">
                        ...
                        {index < order.statusHistory.length - 1 && <div className="h-full w-px bg-border mt-2"></div>}
                      </div>
                      <div className="pb-6">
                        ...
                        {status.note && <p className="text-sm text-muted-foreground mt-1">{status.note}</p>}
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-sm mb-2">
                    {order.deliveryMethod === "pickup" ? "Retrait en boutique" : "Livraison"}
                  </h3>
                  <div className="flex items-start gap-2 text-muted-foreground">
                    {order.deliveryMethod === "pickup" ? (
                      <>
                        ...
                        <div>
                          <p>{formatDate(order.pickupTime?.date || "")}</p>
                          <p>{order.pickupTime?.timeSlot}</p>
                          <p className="mt-1">B-Market, 123 Rue de la Boucherie, 75001 Paris</p>
                        </div>
                      </>
                    ) : (
                      <>
