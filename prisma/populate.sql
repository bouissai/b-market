...
VALUES
    ...
    ('art3', 'Boeuf à bourguignon', 'kg', 16.90, 'bourguignon.jpg', 'Morceaux de boeuf pour bourguignon.', NOW(), NOW(),
     'Boeuf'),
    ('art4', 'Côtelettes d''agneau', 'kg', 29.90, 'cotelettes_agneau.jpg', 'Côtelettes d''agneau fraîches.', NOW(),
     NOW(), 'Agneau'),
    ...
    ('art7', 'Escalopes de poulet', 'kg', 15.90, 'escalopes.jpg', 'Escalopes de poulet fraîches.', NOW(), NOW(),
     'Volaille'),
    ('art8', 'Mélange Ras el hanout', '100g', 3.50, 'ras_el_hanout.jpg', 'Mélange d''épices traditionnel.', NOW(),
     NOW(), 'Épices'),
    ('art9', 'Cumin moulu', '100g', 2.50, 'cumin.jpg', 'Cumin moulu de qualité.', NOW(), NOW(), 'Épices'),
    ('art10', 'Semoule fine', 'kg', 3.90, 'semoule.jpg', 'Semoule fine de qualité supérieure.', NOW(), NOW(),
     'Épicerie'),
    ('art11', 'Huile d''olive', 'litre', 8.90, 'huile_olive.jpg', 'Huile d''olive extra vierge.', NOW(), NOW(),
     'Épicerie');
